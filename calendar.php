...
$PAGE->set_url(new moodle_url('/local/msteams/calendar.php', ['month' => $month]));
...
echo html_writer::div(
    ...
    $OUTPUT->single_button(new moodle_url('/local/msteams/calendar.php', ['month' => $prevmonth]), get_string('previousmonth', 'local_msteams'), 'get') .
    $OUTPUT->single_button(new moodle_url('/local/msteams/calendar.php', ['month' => $nextmonth]), get_string('nextmonth', 'local_msteams'), 'get'),
